...
<main>
	...
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<label>
				<label for="Device"><b>Mã Phòng Ban:</b></label>
			...
			<button type="button" name="user_add" class="user_add btn">Thêm</button>
			<button type="button" name="user_upd" class="user_upd btn">Cập nhật</button>
			<button type="button" name="user_rmo" class="user_rmo btn">Xóa</button>
		</form>
	</div>
